...
@Getter
@Builder
@Schema(description = "영화 찜 정보 반환 DTO")
public class GetFavoriteMovieResponse {
	...
	public static GetFavoriteMovieResponse of(Movie movie) {
		return GetFavoriteMovieResponse.builder()
